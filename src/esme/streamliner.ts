export const config = {
    msal: {
        endpoint: {
            rel: "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=ded5e9d5-eb0c-45c4-a26f-3d665262f8a1&scope=user.read%20mail.read&response_type=code&redirect_uri=http://www.esmerelda.tech/_federal/callback",
